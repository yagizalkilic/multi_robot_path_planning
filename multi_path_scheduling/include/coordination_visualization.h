...
public:
    // Constructor
    CoordinationVisualization( int space_boundary_x, int space_boundary_y, std::vector<int> time_boundary );
    ...
    void draw_velocity(double max_vel, int AGV_amount, double dt, std::vector<std::vector<std::pair<double,double>>> individual_schedules, char* canvas_name);
