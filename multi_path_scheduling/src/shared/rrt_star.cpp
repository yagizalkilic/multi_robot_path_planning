...
RRTStar::RRTStar(int num_dimensions, std::vector<int> space_side_length, 
 ...
 */
bool RRTStar::is_done(const Point& point) const 
{
 ...
 */
bool RRTStar::generate_node(int point_count) 
{
    bool point_ok = false;
    int iteration = 0;
 ...
 */
int RRTStar::nearest_node(const Point& point) const 
{
 ...
 */
bool RRTStar::is_valid(std::vector<Point> points)
{
 ...
 */
std::vector<int> RRTStar::find_nodes_within_radius(const Node& node, double radius) const
{
 ...
 */
void RRTStar::show_longest_generation() const 
{
 ...
 */
void RRTStar::initialize_n_space()
{
 ...
 */
std::vector<int> RRTStar::find_k_nearest_nodes(const Node& node, int k) const
{
