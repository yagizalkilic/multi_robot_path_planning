...
class RRT:
    ...
    def generate_tree(self):
        ...
        total_elapsed_time_node_creation = 0
        done = False
        ...
        while not done:
            ...
            total_elapsed_time_node_creation = total_elapsed_time_node_creation + elapsed_time
        ...
        self.average_node_generation = total_elapsed_time_node_creation / point_count
...
distance_ratio = best_distance / obtained_distance
