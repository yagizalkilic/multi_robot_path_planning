...
int main(int argc, char** argv)
{
    ...
    auto coordination_RRT_star = RRTStar(AGV_amount, collision_side_dimension_length - 1, all_collisions_time);
    ...
    auto velocity_scheduler = VelocityScheduler(all_paths, path_RRT_star, AGV_max_velocity);
